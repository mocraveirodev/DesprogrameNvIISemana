...
//Função para validar os dados dos pacientes
...
document.querySelector("#adicionar-paciente").addEventListener("click", (xuxu) => {
    ...
    document.querySelector("#tabela-pacientes").appendChild(montaTr(paciente)); //Selecionando a tabela e Adicionando a tr criada na tabela.
